...
%changelog
* Fri Mar 14 2014 Sayli Karmarkar <skarmark@redhat.com> 1.1.7-1
- updating version dependency on python-requests to 2.2.1
- removing downloaders that we aren't using or supporting. Both are also known
  to have serious bugs. (mhrivnak@redhat.com)
- some changes to support errata work (jason.connor@gmail.com)
